...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "CreateMnemonicCopyPage_title" : MessageLookupByLibrary.simpleMessage("Backup mnemonic phrase"),
    ...
    "account_login_page_input_hint" : MessageLookupByLibrary.simpleMessage("The seed phrase (or mnemonic phrase) is used for logging in to your wallet. Fill in 12 words in order, and type spaces between the words."),
    ...
    "dialog_defi_hint" : MessageLookupByLibrary.simpleMessage("Box Defi Pledge is one way to get ABC points. An ABC integral has no value and is useless. It is only a sample program written by the developer to experience the blockchain. Not to market development, if you download through other means and try to use the pledge, please turn off this feature."),
    ...
    "dialog_hint_mnemonic" : MessageLookupByLibrary.simpleMessage("The mnemonic is incorrect"),
    ...
    "dialog_name_hint" : MessageLookupByLibrary.simpleMessage("The domain name system is the underlying function of the user blockchain. This application is only for demonstration, and all operations directly access the blockchain. Users should use it at their own risk. No liability shall be assumed for forced use of this app."),
    ...
    "dialog_privacy_confirm" : MessageLookupByLibrary.simpleMessage("Forced to use"),
