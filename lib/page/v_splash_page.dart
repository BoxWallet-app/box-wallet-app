...
import 'package:box/page/v_tab_page_v2.dart';
...
class VSplashPage extends StatefulWidget {
  @override
  _VSplashPageState createState() => _VSplashPageState();
}

class _VSplashPageState extends State<VSplashPage> {
  String _value = "";
      ...
      BoxApp.getCompilerUrl().then((compilerUrl) {
        ...
        BoxApp.getAddress().then((value) {
          SharedPreferences.getInstance().then((sp) {
            ...
            if (value.length > 10) {
              Navigator.pushReplacement(context, CustomRoute(VTabPageV2()));
            } else {
