...
class _DefiRecordsPageState extends State<DefiRecordsPage> with AutomaticKeepAliveClientMixin {
  ...
  void netUpdateV2(int index) {
    EasyLoading.show();
    ContractCallDao.fetch("continue_lock", contractRecordModel.data[index].unlockHeight.toString() + "," + day.toString(), address, "").then((MsgSignModel model) {
      EasyLoading.dismiss();
      if (model.code == 200) {
