...
class TokenTxDetailPage extends StatefulWidget {
  final RecordData recordData;

  const TokenTxDetailPage({Key key, this.recordData}) : super(key: key);

  @override
  _TokenTxDetailPageState createState() => _TokenTxDetailPageState();
}

class _TokenTxDetailPageState extends State<TokenTxDetailPage> {
