...
//                    netUserRegisterData();
                      // ignore: missing_return
                      BoxApp.getGenerateSecretKey(
                          (address, signingKey, mnemonic) {
                        showGeneralDialog(
                            context: context,
                            pageBuilder: (context, anim1, anim2) {},
                            barrierColor: Colors.grey.withOpacity(.4),
                                  ...
                                  child: Opacity(
                                    ...
                                    child: PayPasswordWidget(
                                        ...
                                        passwordCallBackFuture:
                                          ...
                                          var mnemonicAesEncode =
                                              Utils.aesEncode(mnemonic, key);
                  ...
                  child: Opacity(
                    ...
                    child: PayPasswordWidget(
                        ...
                        passwordCallBackFuture: (String password) async {
                          ...
                          var mnemonicAesEncode =
                              Utils.aesEncode(model.data.mnemonic, key);
                          ...
                          Navigator.of(super.context).pushNamedAndRemoveUntil(
                              "/TabPage", ModalRoute.withName("/TabPage"));
                        }),
                  ));
            });
      } else {}
