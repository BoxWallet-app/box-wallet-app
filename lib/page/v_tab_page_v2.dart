...
import 'my_oracle_page.dart';

class VTabPageV2 extends StatefulWidget {
  @override
  _VTabPageV2State createState() => _VTabPageV2State();
}

class _VTabPageV2State extends State<VTabPageV2> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    pageControllerBody.addListener(() {
      if (pageControllerBody.offset < 0 || pageControllerBody.offset > MediaQuery.of(context).size.width) {
        return;
      }
      ...
      _streamControllerLine.sink.add(pageControllerBody.offset / 2);
                      ...
                      StreamBuilder<double>(
                          ...
                          builder: (context, snapshot) {
                            return Positioned(
                                ...
                                child: Container(
                                  height: 3,
                                  margin: EdgeInsets.only(left: MediaQuery.of(context).size.width / 2 / 3, right: MediaQuery.of(context).size.width / 2 / 3),
                                  width: MediaQuery.of(context).size.width / 2 - MediaQuery.of(context).size.width / 2 / 3 - MediaQuery.of(context).size.width / 2 / 3,
                                  //边框设置
                                  decoration: new BoxDecoration(
                                    //背景
    ...
    return Positioned(
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => SettingPageV2()));
          },
          child: Container(
            height: 55,
            width: 55,
