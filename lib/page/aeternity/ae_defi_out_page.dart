...
class AeDefiOutPage extends StatefulWidget {
  AeDefiOutPage({Key key}) : super(key: key);

  @override
  _AeDefiOutPageState createState() => _AeDefiOutPageState();
}

class _AeDefiOutPageState extends State<AeDefiOutPage> {
  Flushbar flush;
...
//      Fluttertoast.showToast(msg: "网络错误" + e.toString(), toastLength: Toast.LENGTH_SHORT, gravity: ToastGravity.CENTER, timeInSecForIosWeb: 1, backgroundColor: Colors.black, textColor: Colors.white, fontSize: 16.0);
  ...
  void clickAllCount() {
    if ((double.parse(AeTokenDefiPage.model.data.count) > 1)) {
      _textEditingController.text = AeTokenDefiPage.model == null ? "" : (double.parse(AeTokenDefiPage.model.data.count) - 0.1).toString();
    }else{
      _textEditingController.text = AeTokenDefiPage.model == null ? "" : (double.parse(AeTokenDefiPage.model.data.count) ).toString();
    }
...
//                                                        image: AssetImage("images/apple-touch-icon.png"),
                                            ...
                                            Positioned(
                                              ...
                                              child: Row(
                                                children: [
                                                  Text(
                                                    AeTokenDefiPage.model == null ? "" : AeTokenDefiPage.model.data.count,
                                                    style: TextStyle(
                                                      color: Color(0xFF666666),
                                                      fontFamily: BoxApp.language == "cn" ? "Ubuntu" : "Ubuntu",
                                                      fontSize: 14,
