                      ...
                      Container(
                        child: Text(
                          AeTokenDefiPage.model == null
                              ? "loading..."
                              : "≈" + AeTokenDefiPage.model.data.token,
                          style: new TextStyle(
                              fontSize: 26,
                            ...
                            Container(
                              child: Text(
                                AeTokenDefiPage.model == null
                                    ? "loading..."
                                    : double.parse(
                                            AeTokenDefiPage.model.data.count)
                                        .toStringAsFixed(2),
                                style: new TextStyle(
                                    fontSize: 24,
                                    fontWeight: FontWeight.w600,
                          ...
                          children: [
                            ...
                            Container(
                              child: Text(
                                AeTokenDefiPage.model == null
                                    ? "loading..."
                                    : AeTokenDefiPage.model.data.allCount + "",
                                style: new TextStyle(
                                    fontSize: 24,
                                    fontWeight: FontWeight.w600,
                                    letterSpacing: 1.5,
    ...
    return Container(
      ...
      child: FlatButton(
        onPressed: () {
          ...
          if (AeTokenDefiPage.model.data.afterHeight <=
              AeTokenDefiPage.model.data.minHeight) {
            var waitHeight = (AeTokenDefiPage.model.data.minHeight +
                    1 -
                    AeTokenDefiPage.model.data.afterHeight) *
                3;
            showPlatformDialog(
              context: context,
  ...
  Container lockBtn() {
    ...
    return Container(
      ...
      child: FlatButton(
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => AeDefiInPage()));
        },
        child: Text(
