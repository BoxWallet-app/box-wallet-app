...
class _AeAeppsPageState extends State<AeAeppsPage>
                                  ...
                                  children: <Widget>[
                                    Container(
                                      ...
                                      child: Image(
                                        ...
                                        height: 56,
                                        image:
                                        AssetImage("images/home_financial.png"),
                                      ),
                                    ),
                                    Container(
                                      padding: const EdgeInsets.only(left: 5),
                                      ...
                                      children: <Widget>[
                                        Container(
                                          ...
                                          child: Image(
                                            ...
                                            height: 56,
                                            image:
                                            AssetImage("images/home_swap.png"),
                                          ),
                                        ),
                                        Container(
                                          padding: const EdgeInsets.only(left: 5),
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      baseNameDataModel == null
                                          ? "-"
                                          : baseNameDataModel.data.sum.toString() +
                                          S
                                              .of(context)
                              ...
                              child: Column(
                                children: <Widget>[
                                  Container(
                                    ...
                                    margin: const EdgeInsets.only(top: 0, left: 20),
                                    child: Text(
                                      S.of(context).home_page_function_name_count +
                                          "(ae)",
                                      style: TextStyle(
                                        fontSize: 14,
                                        wordSpacing: 30.0, //词间距
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      baseNameDataModel == null
                                          ? "-"
                                          : baseNameDataModel.data.sumPrice
                                          .toString() +
                                          S
                                              .of(context)
                                              .home_page_function_name_count_number,
                            ...
                            onTap: () async {
                              ...
                              if (result == 0) {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => AeWeTrueHomePage()));
                              }
                              if (result == 1) {
                            ...
                            Container(
                              ...
                              child: Material(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () {
                                    Navigator.pop(
                                        transitionBuilderContext); //关闭对话框
                                    // ignore: unnecessary_statements
                                    //                                  widget.dismissCallBackFuture("");
                                  },
                                  child: Container(
