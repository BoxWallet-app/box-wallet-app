...
class CfxAccountLoginPage extends StatefulWidget {
  @override
  _CfxAccountLoginPageState createState() => _CfxAccountLoginPageState();
}

class _CfxAccountLoginPageState extends State<CfxAccountLoginPage> {
