...
class CfxAccountAddPage extends StatefulWidget {
  final AddAccountCallBackFuture accountCallBackFuture;

  const CfxAccountAddPage({Key key, this.accountCallBackFuture}) : super(key: key);

  @override
  _CfxAccountAddPageState createState() => _CfxAccountAddPageState();
}

class _CfxAccountAddPageState extends State<CfxAccountAddPage> {
...
//                                cursorRadius: Radius.elliptical(20, 8),
  ...
  clickLogin() {
    ...
    BoxApp.getValidationMnemonic((isSucess) {
      if (isSucess) {
        // ignore: missing_return
        BoxApp.getSecretKeyCFX((address, signingKey) {
          showGeneralDialog(
              context: context,
                          ...
                          passwordCallBackFuture: (String password) async {
                            WalletCoinsManager.instance.getCoins().then((walletCoinModel) {
                              ...
                              if (isExist) {
                                ...
                                WalletCoinsManager.instance.addAccount("CFX", "conflux", address, mnemonicAesEncode, signingKeyAesEncode,false).then((value) {
