...
class CfxTokenReceivePage extends StatefulWidget {
  @override
  _CfxTokenReceivePageState createState() => _CfxTokenReceivePageState();
}

class _CfxTokenReceivePageState extends State<CfxTokenReceivePage> {
  Flushbar flush;
                                  ...
                                  Container(
                                    ...
                                    child: FlatButton(
                                      ...
                                      child: Text(
                                        ...
                                        maxLines: 1,
                                        style: TextStyle(fontSize: 13, color: Color(0xFF37A1DB),fontFamily: BoxApp.language == "cn" ? "Ubuntu":"Ubuntu",),
                                      ),
